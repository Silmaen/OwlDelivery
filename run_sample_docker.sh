...
env="${env} -e EMAIL_HOST=mail.argawaen.net -e EMAIL_PORT=587 -e EMAIL_USE_TLS=True -e EMAIL_HOST_USER=argawaen@argawaen.net -e EMAIL_HOST_PASSWORD=ElorAloric1024\*"
